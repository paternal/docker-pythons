...
ARG PYTHON313=https://www.python.org/ftp/python/3.13.11/Python-3.13.11.tar.xz
ARG PYTHON314=https://www.python.org/ftp/python/3.14.2/Python-3.14.2.tar.xz
ARG PYTHON315=https://www.python.org/ftp/python/3.15.0/Python-3.15.0a2.tar.xz
