...
ARG PYTHON39=https://www.python.org/ftp/python/3.9.22/Python-3.9.22.tar.xz
ARG PYTHON310=https://www.python.org/ftp/python/3.10.17/Python-3.10.17.tar.xz
ARG PYTHON311=https://www.python.org/ftp/python/3.11.12/Python-3.11.12.tar.xz
ARG PYTHON312=https://www.python.org/ftp/python/3.12.10/Python-3.12.10.tar.xz
ARG PYTHON313=https://www.python.org/ftp/python/3.13.3/Python-3.13.3.tar.xz
ARG PYTHON314=https://www.python.org/ftp/python/3.14.0/Python-3.14.0a7.tar.xz
# Pypy https://www.pypy.org/download.html
ARG PYPY27=https://downloads.python.org/pypy/pypy2.7-v7.3.19-linux64.tar.bz2
...
ARG PYPY311=https://downloads.python.org/pypy/pypy3.11-v7.3.19-linux64.tar.bz2
