...
ARG PYTHON310=https://www.python.org/ftp/python/3.10.10/Python-3.10.10.tar.xz
ARG PYTHON311=https://www.python.org/ftp/python/3.11.2/Python-3.11.2.tar.xz
ARG PYTHON312=https://www.python.org/ftp/python/3.12.0/Python-3.12.0a5.tar.xz
